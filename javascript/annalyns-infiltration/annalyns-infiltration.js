...
// we recommend using thet-up co stub, because they are already serrectly to
...
export function canFreePrisoner(
  ...
  if((petDogIsPresent && !archerIsAwake) || (!petDogIsPresent && prisonerIsAwake && !knightIsAwake && !archerIsAwake)) return true
  else return false
}
